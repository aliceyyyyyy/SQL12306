...
<%
    ...
    if("POST".equals(request.getMethod())) {
        ...
        if(trainnum != null && origin != null && destination != null && maxmem != null && normalprice != null) {
            try {
                ...
                String sql = "INSERT INTO train (trainnum, origin, destination, maxmem, normalprice) VALUES " +
                            "('" + trainnum + "', '" + origin + "', '" + destination + "', " + maxmem + ", " + normalprice + ")";
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">添加新车次</h1>
        <p class="page-subtitle">填写车次信息</p>
        
        <div class="card" style="max-width: 600px;">
            <form method="POST" action="train_add.jsp">
                <div class="form-group">
                    <label for="trainnum">车次号 *</label>
                    <input type="text" id="trainnum" name="trainnum" required 
                           placeholder="例如：G1001" pattern="[GCD]\d{4}" 
                           title="格式：G/D/C开头，后跟4位数字">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="maxmem" name="maxmem" required 
                           min="1" max="500" placeholder="例如：200">
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">添加车次</button>
