<%--
  列国驿轨系统 高速铁路 - 订单查询（用户管理员）
  权限：SELECT ticket表
--%>
<%@ page language="java" import="java.sql.*,java.net.URLEncoder" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="ticket_query.jsp" class="active">订单查询</a></li>
    ...
    <div class="container">
        ...
        <p class="page-subtitle">查看所有用户订单信息</p>
        ...
        <div class="card" style="max-width: 100%; margin-bottom: 2rem;">
            <form method="GET" action="ticket_query.jsp" style="display: flex; gap: 1rem; align-items: center; margin-bottom: 1.5rem;">
                ...
                <a href="ticket_query.jsp" class="btn btn-secondary">清除</a>
                <% } %>
            </form>
        </div>
        ...
        <div class="card" style="max-width: 100%;">
            <div class="data-table-wrapper">
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            <td><%=rs.getString("ticketnum")%></td>
                            <td><%=rs.getString("id")%></td>
                            <td><%=rs.getString("seatnum")%></td>
                            <td><%=rs.getString("trainnum")%></td>
            ...
            <div style="display: flex; justify-content: center; align-items: center; gap: 1rem; margin-top: 2rem; padding: 1rem;">
                <%
                    String pageLinkPrefix = "ticket_query.jsp?";
                    if(!searchKeyword.isEmpty()) {
